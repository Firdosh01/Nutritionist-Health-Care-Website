...
import sImg1 from '../assets/About/Image (12).png'
import sImg2 from '../assets/About/Image (13).png'
import sImg3 from '../assets/About/Image (14).png'
import sImg4 from '../assets/About/Image (15).png'
import sImg5 from '../assets/About/Image (16).png'
import sImg6 from '../assets/About/Image (17).png'
import sImg7 from '../assets/About/Image (18).png'
import sImg8 from '../assets/About/Image (19).png'
import sImg9 from '../assets/About/Image (20).png'
import sImg10 from '../assets/About/Image (21).png'
      ...
      <div className="py-5">
        ...
        <div className="flex flex-col items-center md:flex-row">
          ...
          <div className="p-5 md:w-[50%] ">
            ...
            <span className="font-medium ">November 2, 2021</span>
          </div>
        </div>
        ...
        <div className="flex flex-col-reverse items-center md:flex-row">
          <div className="p-5 md:w-[50%] flex flex-col  md:items-end">
            ...
            <span className="font-medium ">July 15, 2019</span>
          </div>
        ...
        <div className="flex flex-col items-center md:flex-row ">
          ...
          <div className="p-5 md:w-[50%] ">
            ...
            <span className="font-medium ">April 1, 2018</span>
          </div>
        </div>
        ...
        <div className="flex flex-col-reverse items-center md:flex-row">
          <div className="p-5 md:w-[50%] flex flex-col md:items-end">
            ...
            <span className="font-medium ">January 20, 2017</span>
          </div>
        ...
        <div className="flex flex-col items-center md:flex-row">
          ...
          <div className="p-5 md:w-[50%] ">
            ...
            <span className="font-medium ">September 5, 2015</span>
          </div>
        </div>
        ...
        <div className="flex flex-col-reverse items-center md:flex-row">
          <div className="p-5 md:w-[50%] flex flex-col md:items-end">
            ...
            <p className="py-5 md:text-end">
              ...
              brought convenience and accessibility to our growing client base.
            </p>
            <span className="font-medium ">June 10, 2014</span>
          </div>
        ...
        <div className="flex flex-col-reverse items-center md:flex-row">
          <div className="p-5 md:w-[50%] flex flex-col  md:items-end">
            ...
            <span className="font-medium ">January 1, 2010</span>
          </div>
